...
const About = () => {
  return (
    <div className="about_container" id="about">
      <header className="about_header">ABOUT PACO</header>
      <FcAbout/>
      <span className="about_text">
       (1) PACO (payment contract) is a <u><b>payment security services</b></u>. This means that by using paco as a product and / or service provider you are ensured that the payment once you have confirmed its deposit cannot be withdrawn by the buyer unless both of you agree.
